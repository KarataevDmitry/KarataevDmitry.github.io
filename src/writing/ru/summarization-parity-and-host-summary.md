...
title: "Равное право подводить итоги и почему сжатие от хоста — плохая опора"
description: "Явное подведение итогов и экспорт переписки — совместная дисциплина; непрозрачное сжатие истории в среде подменяет проверяемый артефакт и ломает паритет."
